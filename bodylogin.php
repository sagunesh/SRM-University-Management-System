...
if (isset($_POST['email'])) {
	...
	if ((!$email) || (!$pass)) { 
		...
		$pass = $pass; // Add MD5 Hash to the password variable they supplied after filtering it
		// Make the SQL query
...
?>
<P>
<br><BR><br><!---This Script is Created By Sagunesh Grover---->
<center><table cellspacing="0" style="border: 1px dashed #3B5999;" width="20%" height="3%"><tr><td><div align="left"> <form action="" method="post" enctype="multipart/form-data" name="signinform" id="signinform">Email:<br />
...
Password:<br /><INPUT type="password" name="pass" id="pass"  STYLE="font-family: Verdana; font-weight: normal; font-size: 12px; background-color:#D8DEEA;width:99.9%;border-color:#000000; border-width:1px;"><br />
  ...
  <center> <table cellspacing="0"><tr><td><input name="remember" type="checkbox" id="remember" value="yes" checked="checked" />
        Remember Me</td><td><td><td>
    <input type="submit" class="myButton" value="login" />
  </form></td>
</tr></table>
  </center>
<center><font color="#3B5999"><?php print "$errorMssg"; ?></font></center></center>
<p>
</tr>
</table>
<?php  ob_end_flush(); ?>