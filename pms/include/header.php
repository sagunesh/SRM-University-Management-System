...
<!--<div id="nav">
<img src="../images/Logo.png" style="position:absolute;left:2%;top:3px;"  height="30px"  >
SRM University Haryana Webmail-->
<?php
if(isset($_SESSION[INT_ACCESS_SESSION])){
?>
<!--<a href="index.php?logout" style="color:#fff;">(Logout)</a>
--><br /><br />
<?php
}
?>
