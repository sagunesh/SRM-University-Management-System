...
(function( $ )
{
    ...
    $.fn.wysiwyg = function( options )
    {
        ...
        options = $.extend({
            html : '<'+'?xml version="1.0" encoding="UTF-8"?'+'><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">STYLE_SHEET</head><body style="margin: 0px;font:12px/1.6em Verdana,Helvetica,Arial,sans-serif;">INITIAL_CONTENT</body></html>',
            css  : {},
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            ...
            italic        : { visible : false, tags : ['i', 'em'], css : { fontStyle : 'italic' }, tooltip : "Italic" },
            ...
            justifyLeft   : { visible : false, css : { textAlign : 'left' }, tooltip : "Justify Left" },
            justifyCenter : { visible : false, tags : ['center'], css : { textAlign : 'center' }, tooltip : "Justify Center" },
            justifyRight  : { visible : false, css : { textAlign : 'right' }, tooltip : "Justify Right" },
            ...
            paste : { visible : true, tooltip : "Paste" },
