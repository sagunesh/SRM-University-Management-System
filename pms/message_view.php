...
<span class="left">Messages with <strong><?php echo $with[0]['User'][INT_USER_NAME];?></strong></span>
</div>
...
<ul class="pm_list">
	...
	<li class="s_clear <?php echo $msg['Message']['sender_id']==$_SESSION[INT_ACCESS_SESSION]?'self':'';?>" >
		...
		<p class="cite">
		<cite><?php echo $msg['User'][INT_USER_NAME];?></cite>
...
<form method="post" action="index.php?reply" class="pmreply">
	...
	<p style="margin: 5px 0pt;">
		<input type="submit" class="myButton" value="Reply"></input>
	</p>
</form>
