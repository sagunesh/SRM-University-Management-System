...
<li><a href="index.php?index_sent" ><span>Sent</span></a></li>
<li class="current"><a href="index.php?index_received"><span>Received</span></a></li>
</ul>
</div>
...
<form method="post" id="pmform" action="index.php?delete">
    ...
    <ul class="pm_list">
        ...
        <p class="more"><a href="index.php?view&id=<?php echo $msg['Message']['id']; ?>">[Reply]</a>&nbsp;<a href="index.php?read&id=<?php echo $msg['Message']['id']; ?>" class="to">[Read Message]</a></p>
        <span class="action">
