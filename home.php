...
<div id="main">
    ...
    <div id="sidebar_main_home"><?php include "sidebar.php"; ?></div>
    <div id="navbar"><?php include "navigationbar.php"; ?></div>
    <div id="content_main_home"><?php include"homelogin.php"; ?></div>
    <div id="footer_main_home"><?php include"footertemplate.php"; ?></div>
</div>
</body>
</html>
